...
| 3 | The Collector | Nim 2D / Chomp | 🚧 In progress — playable console prototype (`coleccionista.py`) |
...
| 6 | Galactic Customs | Ternary search | 🚧 In progress — playable console prototype (`aduana_galactica.py`) |
